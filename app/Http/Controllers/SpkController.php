...
class SpkController extends Controller
{
    ...
    public function storeData(Request $request)
    {
        ...
        DB::table('form_spk')->insert([
            ...
            'plafondKred'           => $request->input('plafondKred_raw'),
            'adm'                   => $request->input('adm_raw'),
            'materai'               => $request->input('materai_raw'),
            'biayaNotaris'          => $request->input('biayaNotaris_raw'),
            'asuransiJiwa'          => $request->input('asuransiJiwa_raw'),
            'asuransiJaminan'       => $request->input('asuransiJaminan_raw'),
            'provisi2'              => $request->input('provisi2_raw'),
            'angPokBung'            => $request->input('angPokBung_raw'),
            'angBung'               => $request->input('angBung_raw'),
            'totBiaya'              => $request->input('totBiaya_raw'),
            'admKredit'             => $admKredit,
