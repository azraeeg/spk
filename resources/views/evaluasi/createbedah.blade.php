...
@section('content')
    <div class="col-md-12">
        <div class="card card-info">
            ...
            <form method="POST" action="{{ route('admin.bedah.store') }}">
                @csrf
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td rowspan="4" style="padding: 8px; text-align:center;">1</td>
                                ...
                                <tr>
                                    <td>2. Kehadiran DPJP untuk visite pasien</td>
                                    <td>100%</td>
                                    <td> <input type="text" class="form-control" name="Hasil2"></td>
                                </tr>
                                <tr>
                                    <td>3. Adanya organ injury pada saat tindakan</td>
                                    <td>1 (satu) kali</td>
                                ...
                                <tr>
                                    ...
                                    <td>2 (dua) kali</td>
                                    <td> <input type="text" class="form-control" name="Hasil10"></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="mt-2">
